 ...
 */
class SensorsFragmentOld : Fragment(), SensorEventListener {
	...
	override fun onCreateView(
		...
		mSensorRecyclerView.layoutManager =
	...
	private inner class SensorHolder(inflater: LayoutInflater, parent: ViewGroup) :
	...
	private inner class SensorAdapter(private val mSensorList: List<Sensor>) :
		androidx.recyclerview.widget.RecyclerView.Adapter<SensorHolder>() {
		...
		override fun onBindViewHolder(holder: SensorHolder, position: Int) {
			val sensor = this@SensorsFragmentOld.mSensorList[position]
			holder.bind(sensor)
		}
